...
Das Projekt besteht aus einem **React‑Frontend** und einer **Node.js‑basierten REST‑API**, die als Schnittstelle zur Datenbank dient.
...
- Tabellenansichten & dynamische UI‑Logik  
...
/ZeiterfassungsApp      → React-Frontend
...
- Berechnung von Soll‑ und Ist‑Stunden  
- Verwaltung von Urlaubstagen  
- API‑Endpunkte für CRUD‑Operationen  
- Mockup‑basiertes UI‑Design  
